...
export class APIService {
  ...
  // POST /topTenEventLocation
  topTenEventLocation(body): Observable<any> {
  ...
  // POST /topTenCameoCodes
  topTenCameoCodes(body): Observable<any> {
    const url = this.baseurl + '/query';
    return this.http.post(url, body)
      .pipe(
        catchError(this.handleError)
  ...
  //POST /numArticlesTime
  numOfArticles(body): Observable<any> {
    const url = this.baseurl + '/query';
    return this.http.post(url, body)
      .pipe(
        catchError(this.handleError)
  ...
  //POST /articleToneTime
  toneChange(body): Observable<any> {
    const url = this.baseurl + '/query';
    return this.http.post(url, body)
      .pipe(
        catchError(this.handleError)
